  ...
  if (fetchError) {
    return (
      <div>
        ...
        <div className="max-w-lg mx-auto mt-12 bg-white rounded-2xl shadow-card border border-gray-100/50 p-8 text-center">
          <AlertCircle size={32} strokeWidth={1.5} className="text-red-400 mx-auto mb-3" />
