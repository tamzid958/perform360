    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[14px] text-gray-500">Checking session...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="w-full max-w-[420px] space-y-8">
          <div className="text-center">
            ...
            <h1 className="text-title text-gray-900">Evaluations Unavailable</h1>
  ...
  if (isValidating) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="flex flex-col items-center gap-3">
          <Loader2 size={24} className="text-brand-500 animate-spin" />
          <p className="text-[14px] text-gray-500">Validating review link...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-[420px] space-y-8">
        ...
        {tokenData && (
          <div className="text-center text-[13px] text-gray-500">
            <p><span className="font-medium text-gray-700">{tokenData.cycleName}</span></p>
