...
import { Menu, X, LayoutDashboard, RefreshCcw, Users, FileText, UserCircle, Settings, LogOut, Building2 } from "lucide-react";
            ...
            <div className="px-3 py-3 border-t border-gray-200/50 space-y-1">
              ...
              {companyCount > 1 && (
                <button
                  ...
                  className="flex items-center justify-center px-2 py-2.5 rounded-xl text-[14px] font-medium transition-all duration-200 w-full text-gray-500 hover:text-gray-700 hover:bg-gray-200/40"
                >
