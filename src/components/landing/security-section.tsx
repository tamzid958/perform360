...
export function SecuritySection() {
  return (
    <section id="security" className="bg-gray-50 py-16 sm:py-28 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="h-full">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 text-brand-500 hover:text-brand-600 text-[14px] font-medium mt-8 transition-colors"
            >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[0_2px_20px_rgba(0,0,0,0.04)] border border-gray-100 h-full flex flex-col justify-center">
            ...
            <div className="flex flex-col items-center">
              <div className="w-0.5 h-8 bg-gradient-to-b from-brand-500/30 to-brand-500/10" />
              <ChevronDown size={16} strokeWidth={1.5} className="text-brand-500/40 -mt-1" />
            </div>

            {/* Card 2 — Master Key */}
            <div className="bg-gradient-to-r from-green-50 to-white rounded-xl p-5 border border-green-500/10">
              <div className="flex items-center gap-4">
            ...
            {/* Connector */}
            <div className="flex flex-col items-center">
              <div className="w-0.5 h-8 bg-gradient-to-b from-green-500/30 to-purple-500/10" />
              <ChevronDown size={16} strokeWidth={1.5} className="text-purple-500/40 -mt-1" />
            </div>

            {/* Card 3 — Encrypted Responses */}
            <div className="bg-gradient-to-r from-purple-50 to-white rounded-xl p-5 border border-purple-500/10">
              <div className="flex items-center gap-4">
