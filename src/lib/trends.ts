...
async function buildScoredCyclePoint(
  ...
  // 1. Fetch assignments for completion rate
  ...
  // 3. Fetch templates and extract rating question IDs
  ...
  // 4. Fetch and decrypt all responses
