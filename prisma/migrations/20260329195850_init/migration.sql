-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'HR', 'EMPLOYEE', 'EXTERNAL');

-- CreateEnum
CREATE TYPE "TeamMemberRole" AS ENUM ('MANAGER', 'MEMBER', 'EXTERNAL', 'IMPERSONATOR');
...
CREATE TABLE "TeamMember" (
    ...
    "levelId" TEXT,
    "impersonatorRelationships" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
CREATE TABLE "CycleTeam" (
    ...
    "templateId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "weightManager" DOUBLE PRECISION,
    "weightPeer" DOUBLE PRECISION,
    "weightDirectReport" DOUBLE PRECISION,
    "weightSelf" DOUBLE PRECISION,
    "weightExternal" DOUBLE PRECISION,
    "weightPreset" TEXT,
    "mgrWeightManager" DOUBLE PRECISION,
    "mgrWeightPeer" DOUBLE PRECISION,
    "mgrWeightDirectReport" DOUBLE PRECISION,
    "mgrWeightSelf" DOUBLE PRECISION,
    "mgrWeightExternal" DOUBLE PRECISION,
    "calibrationOffset" DOUBLE PRECISION,
    "calibrationJustification" TEXT,
    "calibrationAdjustedBy" TEXT,
...
-- CreateIndex
CREATE INDEX "EvaluationCycle_companyId_status_idx" ON "EvaluationCycle"("companyId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "CycleTeam_cycleId_teamId_key" ON "CycleTeam"("cycleId", "teamId");

-- CreateIndex
CREATE INDEX "CycleTeamLevelTemplate_cycleTeamId_idx" ON "CycleTeamLevelTemplate"("cycleTeamId");

-- CreateIndex
CREATE UNIQUE INDEX "EvaluationAssignment_token_key" ON "EvaluationAssignment"("token");

-- CreateIndex
CREATE INDEX "EvaluationAssignment_cycleId_status_idx" ON "EvaluationAssignment"("cycleId", "status");

-- CreateIndex
CREATE INDEX "EvaluationAssignment_cycleId_subjectId_idx" ON "EvaluationAssignment"("cycleId", "subjectId");
...
-- CreateIndex
CREATE INDEX "EvaluationResponse_subjectId_idx" ON "EvaluationResponse"("subjectId");

-- CreateIndex
CREATE INDEX "EvaluationResponse_assignmentId_idx" ON "EvaluationResponse"("assignmentId");
...
-- AddForeignKey
ALTER TABLE "CycleTeamLevelTemplate" ADD CONSTRAINT "CycleTeamLevelTemplate_levelId_fkey" FOREIGN KEY ("levelId") REFERENCES "Level"("id") ON DELETE SET NULL ON UPDATE CASCADE;
